...
const { addChild, getChildren, getChild, getParentChildren } = require("../CONTROLLER/child.controller")
...
router.get("/children/:id", protect, authorize("getParentChildren"), getParentChildren);
