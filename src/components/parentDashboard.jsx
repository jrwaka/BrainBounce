  ...
  return (
    ...
    <div>
        ...
        <div className="w-64 fixed inset-y-0 left-0 h-full bg-black text-white p-6 flex flex-col justify-between">
            ...
            <ul className="flex-1">
                <li className="mb-10">
                    <Link to="components/small_parent_component/Dashboard" className="flex items-center hover:text-yellow-400">
                        <FiGrid className="mr-2" /> Dashboard
                    </Link>
                </li>
                <li className="mb-10">
                    <Link to="components/small_parent_component/parent-profile" className="flex items-center hover:text-yellow-400">
